...
TARGET_BOOTLOADER_BOARD_NAME := a22x          # From ro.product.board
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 40960
...
TW_THEME := portrait_xhdpi                     # Set the exact theme you wanna use. If resulation doesn't match, define the height/width
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x11088000 --tags_offset 0x07c08000
